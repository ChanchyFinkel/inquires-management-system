...
- Keep the four-project dependency direction: `Inquires.Api` -> `Inquires.Services` -> `Inquires.Data` and `Inquires.DTO`; `Inquires.DTO` references `Inquires.Data`.
